...
func handleGoVersionInfo(registryService *registry.Service) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		artifact, _, err := registryService.Download(ctx, module, version)
		if err != nil {
...
func handleGoModuleDownload(registryService *registry.Service) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		artifact, content, err := registryService.Download(ctx, module, version)
		if err != nil {
...
func handleGoModuleUpload(registryService *registry.Service) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		filename := fmt.Sprintf("%s@%s.zip", module, version)
		err := registryService.Upload(ctx, "go", filename, c.Request.Body, "application/zip")
		if err != nil {
...
func handleGoModuleDelete(registryService *registry.Service) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		err := registryService.Delete(ctx, module, version)
		if err != nil {
